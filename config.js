...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("2349038303472")
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Prince_walex:prince123@cluster0.brptzkb.mongodb.net/?retryWrites=true&w=majority
"
global.port= process.env.PORT || 5000
global.email = 'sam@sec.live'
global.github = 'https://github.com/Qhingthuth/PRABATH-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/qhingthuth' // add your username
global.devs = '94762280384';
global.website = 'https://github.com/Qhingthuth/PRABATH-MD' //wa.me/+2349038303472
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'PRINCE.W.MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '2349038303472',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY PRINCE.W-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'PRINCE.W',
  ...
  LANG: process.env.THEME|| 'PRINCE.W-MD',
